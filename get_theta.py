...
def get_crosspoint(points,width,height):
...
def calculate_angle(img):
    # Kmeans the lines from HoughLinesP and match the perpendicular ones 
...
def read_angle(env):
    ...
    env.back_cap = cv2.VideoCapture(3)
